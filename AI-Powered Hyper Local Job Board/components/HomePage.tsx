...
export function HomePage({ onGetStarted, onViewJobs, onSignIn }: HomePageProps) {
  const stats = [
  ...
  const testimonials = [
    {
      ...
      text: 'LocalJobs AI helped me find my dream job just 3 blocks from my apartment. The AI matching was incredibly accurate!'
    },
    {
      name: 'Mike Chen',
      role: 'Marketing Manager',
      company: 'Creative Agency',
      text: 'As an employer, I love how LocalJobs AI connects me with local talent. The quality of candidates is outstanding.'
    },
    {
      name: 'Lisa Rodriguez',
      role: 'UX Designer',
        ...
        <div className="container mx-auto px-4 py-16 lg:py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <Button size="lg" variant="outline" onClick={onViewJobs} className="text-lg px-8">
                Browse Jobs
              </Button>
            </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl font-medium mb-6">Why Choose LocalJobs AI?</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <Button size="lg" onClick={onViewJobs} className="h-12 px-8">
                Search Jobs
              </Button>
            </div>
            <p className="text-sm text-muted-foreground">
              Or <Button variant="link" onClick={onSignIn} className="p-0 h-auto">sign in</Button> to get personalized recommendations
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" onClick={onViewJobs} className="text-lg px-8 border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary">
              Browse All Jobs
            </Button>
          </div>
        </div>
